 ...
 const user = [
      { email: "alice123@gamil.com", password: "alice123" },
        { email: "ved123@gamil.com", password: "veryd123" },
          { email: "charlie@gmail.com", password: "1fj234xyz" },
 ];
 
 app.put("/user", async (requestAnimationFrame, res) => {
 ...
 app.delete("/user", async (requestAnimationFrame, res) => {
      try {
